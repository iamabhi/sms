...
/**
 * @ngdoc function
 * @name inditesmsApp.controller:ExamsCtrl
 * @description
 * # ExamsCtrl
 * Controller of the inditesmsApp
 */
angular.module('inditesmsApp')
  .controller('ExamsCtrl', function ($scope, $routeParams, $location, $filter, Data) {
    $scope.templates = Data.initExams($routeParams.gid);
    $scope.aindex = $routeParams.aindex;
    ...
    $scope.editTodo = function (template) {
        ...
        $scope.originalTodo = angular.extend({}, {});
    };
